...
/*
  ...
  #define PARAM_GF_POLY                       Define p(x) = 1 + x^3 + x^10 the primitive polynomial of degree 10 in hexadecimal representation
...
// in one 256-bit word.
#define SYND_SIZE_256                       CEIL_DIVIDE(PARAM_DELTA, 8)

#define UTILS_REJECTION_THRESHOLD           16721653
