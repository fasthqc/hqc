...
#define SIZE_N 24192// pour PARAM_N = 70853 : (24192-2*256)*3 = 71040, avec (8192-128)*3 = 24192


#define T_TM3 24320//SIZE_N//
...
int TOOM3Mult(uint64_t* A, uint64_t* B, uint64_t* Out)//size est en nombre de mots de 256 bits !!!
{
...
static inline int divByXplus1_256(__m256i* in,__m256i* out,int size){//mod X^N !!! N = 
 ...
 int TOOM3RECMult(uint64_t* A, uint64_t* B, uint64_t* Out)
{
