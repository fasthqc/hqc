 ...
 */
void vect_fixed_weight_by_coordinates(uint32_t* v, const uint16_t weight, AES_XOF_struct* ctx) {
  unsigned long random_bytes_size = 3 * weight;
  unsigned char rand_bytes[3 * PARAM_OMEGA_E] = {0};
 ...
 */
void vect_print_sparse(uint32_t* v, uint16_t weight) {
