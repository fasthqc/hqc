...
#define T_TM3R_3W (PARAM_N/3)
#define T_TM3R (PARAM_N+384)
...
int Toom3RecMult(uint64_t * A, uint64_t * B, uint64_t * C);//size est en nombre de mots de 256 bits !!!
